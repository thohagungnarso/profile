...
<head>
    ...
    <body id="menu" class="alt-bg">
        ...
        <div class="page-loader" id="page-loader">
            <div><i class="fa fa-spinner"></i><p>loading</p></div>
        </div>
		...
		<nav class="quick-link count-4 nav-left">
			...
			<ul id="qmenu" class="qmenu">
				<li data-menuanchor="home">
					<a href="#home" class=""><i class="fa fa-home"></i>
					</a>
					<span class="title">Home page</span>
				</li>
				<li data-menuanchor="register">
					<a href="#register"><i class="fa fa-stack-overflow"></i>
					</a>
					<span class="title">Work Experience</span>
				</li>
				<li data-menuanchor="about-me">
					<a href="#about-me"><i class="fa fa-user"></i>
					</a>
				...
				<li data-menuanchor="contact">
					<a href="#contact"><i class="fa fa-address-book"></i>
					</a>
					<span class="title">Contact</span>
				</li>
			</ul>
        ...
        <div class="page-cover" id="s-cover">
            <!-- Cover Background -->
            <center>
			<!-- <img src="img/logo1.png" width="100" height="100" style=""> -->
			</center>
			...
			<div class="content">
				...
				<div class="clock clock-countdown">
					<div class="site-config"
						 data-date="01/30/2017 00:00:00" 
						 data-date-timezone="+0"
						 ></div>					
					<div class="elem-center">
						<div class="digit">
							<span class="days">IT</span>
							<span class="txt"></span>
						</div>
					</div>
					<!-- Logo instead -->
...
<!--						<span class="days">12</span><span class="thin">D</span>-->
						<span class="hours">PROGRAMMER</span><span class="thin"><!-- H --></span>
				...
				<footer>
					<p>Have a high spirit, dedicated, accustomed to Job pressure, not easily give up and high end Professionalism of work. Like the challenge. Experienced in website programming.</p>
				</footer>                
			</div> 
		</div>
		<!-- End of timer pane -->
        ...
        <main class="page-main" id="mainpage">             
				...
				<section class="content">
					...
					<header class="header">
						<div class="h-left">
							...
							<h2><strong style="color:#ef4923;">Thoh Agung Narso</strong></h2>
						</div>

						<div class="h-right">

							<h3>IT <br>Professional</h3>
							<h4 class="subhead"><a href="#about-me">find out more</a></h4>
						</div>
					</header>
				</section>
            ...
            <div class="section page-register page page-cent"  id="s-register">
                <section class="content">
                    <header class="p-title">
                        <h3>Experience <i class="fa fa-stack-overflow"></i></h3> 
						<h5 class="subhead">Work experience</h5><br>
                    </header>
                    <div>
                            <p class="invite">Understand the concept of oop, native, and mvc programming. Familiar with framework (React Native (Mobile Apps), Laravel, vuejs) and cms (WordPress, Opencart, WooCommerce, etc.). Experts in database management, have a good understanding of the query can operate beberapat type of database (postgress, MySQL, SQL Server, etc.).</p>
                        <!-- <form id="mail-subscription" class="form magic send_email_form" method="get" action="http://highhay.com/demos/timex/ajaxserver/serverfile.php">
            ...
            <div class="section page-about page page-cent" id="s-about-me">
                <section class="content">
                    <header class="p-title">
                        <h3>About Me<i class="fa fa-user-circle-o">
                            </i>
                        </h3>
						<h4 class="subhead">Let's make  <span class="bold">IT</span> happen</h4>
                    </header>
                    <article class="text">
                    <p>I'm IT Professional who master the handling of software, hardware and computer networks.</p>
					<p>Experienced more than 3 years and has produced some excellent projects,
					Providing solutions for IT problems predictably efficient and precise.</p>
                    </article>
                </section>
                <footer class="p-footer p-scrolldown">
                    <a href="#contact">
            ...
            <div class="section page-contact page page-cent  bg-color" data-bgcolor="rgba(95, 25, 208, 0.88)s" id="s-contact">
				...
				<div class="slide" id="s-information" data-anchor="information">
					<section class="content">
						<header class="p-title">
							<h3>Contact<i class="fa fa-address-book-o">
								</i>
							</h3>
							<ul class="buttons">
								<li class="show-for-medium-up">
									<a title="About" href="#about-me" ><i class="fa fa-user"></i></a>
								</li>
								<!--<li>
									<a title="Contact" href="#contact/information"><i class="ion ion-location"></i></a>
								</li>-->
								<!-- <li>
									<a title="Message" href="#contact/message"><i class="fa fa-envelope"></i></a>
								</li> -->
							</ul>
						</header>
							...
							<div class="row">
								<div class="medium-6 columns left">
									<ul>
										<li>
											<h4>Email</h4>
											<p>thohagungnarso@gmail.com</p>
										</li>
										<li>
											<h4>Address</h4>
											<p>Cikokol Kebon Nanas
											<br>Tangerang Kota</p>
										</li>
										<li>
											<h4>Mobile</h4>
								...
								<div class="medium-6 columns social-links right">
									<ul>
										...
										<li class="show-for-medium-up">
											<h4>Website</h4>
											<p><a href="/">www.thohagung.com</a></p>
										</li>
										<li  class="show-for-medium-up">
											<h4>Find us on</h4>
											...
											<div class="socialnet">
												...
												<a href="http://www.twitter.com/thoh_agung"><i class="fa fa-twitter"></i></a>
										...
										<li>
											...
											<p class="small">Design by <strong><a href="/">Thoh Agung</a></strong>. All right reserved 2017</p>
										</li>
									</ul>
				...
				<div class="slide" id="s-message" data-anchor="message">
					<section class="content">
						<header class="p-title">
							<h3>Write to us<i class="fa fa-envelope">
								</i>
							</h3>
							<ul class="buttons">
								<li class="show-for-medium-up">
								...
								<li>
									<a title="Contact" href="#contact/information"><i class="fa fa-address-book-o"></i></a>
								</li>
								<!--<li>
		...
		<footer class="page-footer">
			<div>
				...
				<a href="http://twitter.com/thoh_agung" target="_blank"><i class="fa fa-twitter"></i></a>
				<a href="http://facebook.com/thoh.narso" target="_blank"><i class="fa fa-facebook"></i></a>
			</div>
		</footer>
		<!-- End of site footer -->
...
<!--		<script src="//code.jquery.com/jquery-1.11.2.min.js"></script>-->
        <script src="https://ajax.cloudflare.com/cdn-cgi/scripts/78d64697/cloudflare-static/email-decode.min.js"></script><script src="js/vendor/jquery-1.11.2.min.js"></script>
		<!-- All vendor scripts -->
...
<!-- Mirrored from highhay.com/demos/timex/index-video.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Dec 2016 21:36:09 GMT -->
</html>
